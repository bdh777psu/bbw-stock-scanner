...
This is a technical analysis tool that can be used to identify potential price breakouts or breakdowns for (almost) all stocks at once on select exchanges (NYSE, NASDAQ & B3 (Brazil) and Binance): By entering the desired value into the tool, one can filter out for stocks with tight prices that are about to rise or fall.
